...
<xsl:param name="column.count.back" select="1"/> -->
    ...
    <xsl:attribute-set name="component.title.properties">
        <xsl:attribute name="color">#cc6600</xsl:attribute>
    </xsl:attribute-set>

    <xsl:template name="table.of.contents.titlepage" priority="1">
        <fo:block xsl:use-attribute-sets="section.title.toc.properties"
            space-before="1in"
    ...
    <xsl:attribute-set name="section.title.toc.properties">
    ...
    <!-- 
        ==========================================================================
        Itemized list is using the list.block.properties
        Customize this to get a small indent for each itemized block
        ==========================================================================        
    -->
