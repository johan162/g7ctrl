 ...
 * SVN:         $Id: xstr.c 874 2015-03-21 16:59:54Z ljp $
 *
...
/**
 * Increas byte index to next mb code-point
 * @param s
 * @param i
 */
void
...
/**
 * Decrease byte indec to previous mb code-point
 * @param s
 * @param i
 */
void
 ...
 * @param s2 Source
 * @param maxbuff Maximum buffert size of s1 (includes the terminating 0)
 * @return s1
 */
char *
